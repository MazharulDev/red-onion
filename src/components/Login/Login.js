    ...
    return (
        ...
        <div>
            ...
            <form className='mx-auto mt-16 w-2/5'>
                <input className='bg-gray-200 p-3 rounded w-full mb-4' type="email" name=""  placeholder='Email' />
                <input className='bg-gray-200 p-3 rounded w-full mb-4' type="password" name=""  placeholder='Password' />
